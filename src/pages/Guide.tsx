      ...
      <main className="page guide">
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              動かしたくないレイヤーは鍵アイコンでロックします。ロック中は移動・拡大縮小・回転・反転・削除・不透明度の変更ができず、キャンバスでタップしても選択されないので、下のレイヤーを操作できます。
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            とホーム画面のアプリの間でも読み込めます。読み込むと、元の素材とフレームは削除されてバックアップの内容に置き換わります。
          </p>
        </section>
      </main>
    </div>
